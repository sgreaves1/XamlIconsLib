...
namespace XamlIconLibrary
{
    ...
    public static class MaterialDesignIconsHelper
    {
        ...
        /// </summary>
        public static string UpdateData(MaterialDesignIcons icon)
        {
            string data = "";
