...
namespace XamlIconLibrary
{
    ...
    public partial class AccountBalance
    {
        ...
        public static readonly DependencyProperty IconBorderColorProperty =
            DependencyProperty.Register("IconBorderColor", typeof(Brush), typeof(AccountBalance), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty IconBorderThicknessProperty =
            DependencyProperty.Register("IconBorderThickness", typeof(int), typeof(AccountBalance), new PropertyMetadata(0));
        ...
        public static readonly DependencyProperty AuthorProperty =
            DependencyProperty.Register("Author", typeof(string), typeof(AccountBalance), new PropertyMetadata("Google"));
        ...
        public static readonly DependencyProperty SourceProperty =
            DependencyProperty.Register("Source", typeof(string), typeof(AccountBalance), new PropertyMetadata("https://design.google.com/icons/"));
        ...
        public static readonly DependencyProperty ShowCreditsProperty =
            DependencyProperty.Register("ShowCredits", typeof(bool), typeof(AccountBalance), new PropertyMetadata(false));
    }
}
